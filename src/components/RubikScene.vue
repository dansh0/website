...
<!-- <script lang="ts" type="module" src="../assets/ts/scene.ts">  -->
<script lang="ts">
...
export default class RubikScene extends Vue {
    mounted() {
        // scene
        const scene = new THREE.Scene();

        // camera
        // const canvasWidth = this.$refs.container.innerWidth;
        // const canvasHeight = this.$refs.container.innerHeight;
